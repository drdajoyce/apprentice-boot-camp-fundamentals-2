namespace apprentice_bootcamp_fundamentals_2 {
  public class Checkout {
    public int _total;
    public int _numberOfA;
    public int _numberOfB;
    private Receipt _receipt = new Receipt();

    public string Receipt {
      get => this._receipt.Text; set => this._receipt._total = _total;
    }
    ...
    public void Scan(string sku) {
      if ("A".Equals(sku)) {
        this._total += 50;
        this._receipt._total += 50;
        this._receipt.ScannedA();
        this._numberOfA++;
        if (this._numberOfA % 5 == 0) {
          this._total -= 30;
          this._receipt._total -= 30;
        }
        ...
        if (this._numberOfB % 2 == 0) {
          this._total -= 15;
          this._receipt._total -= 15;
        }
      } else if ("C".Equals(sku)) {
        this._total += 20;
        this._receipt._total += 20;
